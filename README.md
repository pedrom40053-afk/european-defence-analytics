...
An end-to-end data analytics project exploring how European NATO Allies have transformed their defence spending since 2014, with a particular focus on defence burden, equipment investment, expenditure structure and the projected outlook for 2026.
...
In 2014, only **2 of the 29 European Allies** included in the analysis spent at least 2% of GDP on defence: **Greece (2.24%)** and the **United Kingdom (2.13%)**. Greece therefore recorded the highest defence burden among the European Allies included in the project in 2014.
...
**Greece**, for example, had a relatively high defence burden of **2.77% of GDP in 2024**, while approximately **61.12%** of its defence expenditure was allocated to personnel.
...
### 1. European Defence Investment Monitor

A high-level overview of European NATO defence expenditure. The dashboard combines the average country defence burden, equipment allocation, annual real spending change, the **NATO Benchmark**, the long-term burden trend and a country ranking for the selected year.

The line and KPI labelled **NATO Benchmark** correspond to NATO's published **NATO Europe and Canada aggregate** for defence expenditure as a share of real GDP. This is **not** the project's simple unweighted cross-country average and it is **not** NATO's formal spending target.

![European Defence Investment Monitor](dashboard/screenshots/01_European_Defence_Overview.png)

---

### 2. Country Defence Profile

An interactive country-level view designed to analyse a selected Ally's defence trajectory, current expenditure structure and estimated 2026 position.

The dashboard includes:

* Defence burden in 2024 and 2026E
* Equipment and personnel shares in 2024
* Defence burden evolution relative to the **NATO Benchmark**
* Defence spending composition by category
* **Real Defence Spending Growth** over time

The **Real Defence Spending Growth** visual uses NATO's **annual real change (%)** series. It represents the year-on-year change in defence expenditure in real terms, using constant **2021 prices** to remove the effect of inflation. Positive values indicate a real increase in spending relative to the previous year, while negative values indicate a real decrease. Values identified as estimates in the NATO source remain estimates in the dashboard.

For the spending-composition visual, a year is displayed only when the full category breakdown is available. In the source data, **Netherlands and Portugal have a 2026 equipment-share estimate but do not have complete 2026 values for the remaining composition categories**. Their 2026 composition bar is therefore intentionally omitted rather than treating unavailable categories as zero. The available 2026 equipment-share estimate is still retained for analyses that use that indicator independently.

![Country Defence Profile](dashboard/screenshots/02_Country_Explorer.png)

---

### 3. Strategic Defence Transformation

Analysis of structural change in European defence spending between **2014 and 2024**, combining changes in defence burden with changes in equipment and personnel allocation.

The scatter plot positions countries according to two dimensions:

* **Horizontal axis:** change in defence burden (percentage points)
* **Vertical axis:** change in equipment share (percentage points)

Reference lines represent the average changes across the 29 countries included in the analysis. This makes it possible to distinguish countries combining an above-average increase in defence effort with an above-average shift towards equipment from countries following different expenditure trajectories.

![Strategic Defence Transformation](dashboard/screenshots/03_Strategic_Transformation.jpg)

---

### 4. European Defence Outlook 2026

A forward-looking comparison of the **2024 observed position** with NATO's **2026 estimates**.
...
The dashboard combines projected defence-burden acceleration with changes in equipment allocation, identifies the countries with the strongest estimated burden increases and compares selected countries across 2024 and 2026E.

![European Defence Outlook 2026](dashboard/screenshots/04_European_Defence_Outlook_2026.jpg)

---

## Metric Definitions

* **Defence Burden:** defence expenditure as a share of GDP (%).
* **Equipment Share:** equipment expenditure as a share of total defence expenditure (%).
* **Personnel Share:** personnel expenditure as a share of total defence expenditure (%).
* **Real Defence Spending Growth:** NATO's annual real change in defence expenditure (%), measured year-on-year in constant 2021 prices.
* **NATO Benchmark:** NATO's published **NATO Europe and Canada aggregate** for defence expenditure as a share of real GDP. It is a reference series, not the project's country average and not a formal NATO spending target.
* **Percentage-point change (pp):** the absolute difference between two percentage values. For example, an increase from 2.0% to 2.5% equals **+0.5 pp**, not +0.5%.
* **Observed / Estimate:** the dashboards distinguish historical observations from values identified as estimates in the NATO source data.
...
* Apply dashboard-level filters and completeness rules for valid visual comparisons

---

## Data Quality Assurance

Before publication, automated QA checks were implemented in Python to validate the analytical datasets, followed by dashboard-level validation in Power BI.
...
* Country-ranking validation for Top N visuals
* Handling of incomplete expenditure-composition records without converting missing values to zero

All final data and dashboard validation checks were completed before publication.
...
└── dashboard/
    └── screenshots/
        ├── 01_European_Defence_Overview.png
        ├── 02_Country_Explorer.png
        ├── 03_Strategic_Transformation.jpg
        └── 04_European_Defence_Outlook_2026.jpg
```
...
Cross-country averages reported in this project are **simple, unweighted averages across the countries included in the analysis**, unless otherwise stated. The **NATO Europe and Canada aggregate** shown as the dashboard's *NATO Benchmark* is an official NATO aggregate and should not be interpreted as this simple cross-country average.

The **2% of GDP threshold** is used in this project as the historical NATO burden-sharing guideline adopted in 2014 for longitudinal comparison. It should not be confused with NATO's newer defence-investment commitment agreed at the 2025 Hague Summit.
...
Expenditure-composition charts require the relevant category breakdown to be complete. Missing source values are preserved as missing and are **not** automatically replaced by zero or inferred from the remaining categories. This is why the 2026 composition bar is omitted for Netherlands and Portugal in the Country Defence Profile even though a 2026 equipment-share estimate is available for those countries.
